...
<html>
    <head>
        ...
        <meta name="userLoggedIn" content="<?php echo isset($_SESSION['email']) ? 'true' : 'false'; ?>"> <!-- Store information about the user's login status and then use JavaScript to show/hide elements based on that status !-->
    ...
    <body>
                ...
                <div id="user-info">
                    <?php
                        if(isset($_SESSION["email"])){
                            ...
                            <img src="./media/profile_circle.png">   
        ...
        <div id="menu">
            <div id="logged-id-menu-buttons">
                <div>
                    <span><a href="profile.php">Il mio account</a></span>
                </div>
                <div>
                    <span><a href="mybookings.php">Le mie prenotazioni</a></span>
                </div>
            </div>
            <div id="logout">
